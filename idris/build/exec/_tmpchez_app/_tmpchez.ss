#!/nix/store/vsg7k5phmzmvfgfalq0s12rdad93vwhk-chez-scheme-10.0.0/bin/scheme --program
...
(define csegen-16 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_String u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_String u--d u--x)))))
...
(define Main-getInput (lambda (arg-0 arg-1 ext-0) (let ((act-1 ((SystemC-45FileC-45ReadWrite-readFile csegen-13 (string-append "../input/" (string-append (PreludeC-45Show-u--show_Show_Nat arg-0) (string-append "/" (string-append (PreludeC-45Show-u--show_Show_Nat arg-1) ".input"))))) ext-0))) (case (vector-ref act-1 0) ((1) (let ((e-2 (vector-ref act-1 1))) (let ((act-2 (PreludeC-45IO-prim__putStr (string-append e-2 "\xa;") ext-0))) (box e-2)))) (else (let ((act-2 (PreludeC-45IO-prim__putStr (string-append (string-append "Error fetching input for year" (string-append (PreludeC-45Show-u--show_Show_Nat arg-0) (string-append " day " (PreludeC-45Show-u--show_Show_Nat arg-1)))) "\xa;") ext-0))) '()))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Hello AoC!\xa;" ext-0))) (let ((act-2 ((SystemC-45Directory-currentDir csegen-13) ext-0))) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40MaybeC-32C-36aC-41 csegen-16 act-2) "\xa;") ext-0))) (let ((act-4 (Main-getInput 2023 1 ext-0))) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40MaybeC-32C-36aC-41 csegen-16 act-4) "\xa;") ext-0)))))))
