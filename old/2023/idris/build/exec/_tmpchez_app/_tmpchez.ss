...
(define Day1-main (lambda (ext-0) (let ((act-1 (Day1-readInput ext-0))) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40MaybeC-32C-36aC-41 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_String u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_String u--d u--x)))) act-1) "\xa;") ext-0))))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (Day1-main eta-0)))
  (collect 4)
